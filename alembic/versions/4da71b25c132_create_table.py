...
Revision ID: 4da71b25c132
Revises: 
Create Date: 2024-09-23 14:14:38.853814
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['author_id'], ['authors.id'], onupdate='CASCADE', ondelete='RESTRICT'),
